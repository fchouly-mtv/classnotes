...
\fancyhf{}%
\fancyfoot[C]{}%
\fancyhead[RE]{ISIFC 1re ann\'ee - Traitement du Signal - \textsc{2016/17}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
} %
\fancyhead[LO]{ISIFC 1re ann\'ee - Traitement du Signal - \textsc{2016/17}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
}
