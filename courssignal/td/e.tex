...
\usepackage{calc}	% Les dépendances de phystricks.
...
\fancyhf{}%
\fancyfoot[C]{}%
\fancyhead[RE]{ISIFC 1re ann\'ee - Traitement du Signal - \textsc{2017/18}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
} %
\fancyhead[LO]{ISIFC 1re ann\'ee - Traitement du Signal - \textsc{2017/18}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
}
...
\theoremstyle{MyRemarks}	\newtheorem{remark}[numtho]{Remarque}
				...
				\newtheorem{probleme}[numprob]{\fbox{\bf Probl\`emes et choses \`a faire}}
