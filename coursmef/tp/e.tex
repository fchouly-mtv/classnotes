...
\fancyhf{}%
\fancyfoot[C]{}%
%\fancyhead[RE]{L2 - Expression écrite et orale - \textsc{2018/19}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
%} %
\fancyhead[LO]{MIGS 2 - TP Calcul Scientifique 2 - \textsc{2019/20}\hfill  %\textsc{\footnotesize Laboratoire de Math\'ematiques de Besan\c{c}on}
}
